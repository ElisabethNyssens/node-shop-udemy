  ...
  req.user
    ...
    .then((user) => {
      ...
      return stripe.checkout.sessions.create({
        ...
        mode: "payment",
        success_url: req.protocol + "://" + req.get("host") + "/checkout/success", // http://localhost:3000/checkout/succes
  ...
  Order.findById(orderId)
    .then((order) => {
      ...
      order.products.forEach((prod) => {
        pdfDoc.text(
          prod.quantity + " " + prod.product.title + " x $" + prod.product.price
        );
      ...
      // not a good practice for big files
      ...
      // read step by step in differents chunks
